...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(com.example.onlinecoursebackend.db.repositories.UserRepository userRepository, PasswordEncoder passwordEncoder) {
    ...
    public void run(String... args) throws Exception {
       if (userRepository.findAll().isEmpty()) {
           ...
           superadmin.setFullName("Zafar Ziyatov");
